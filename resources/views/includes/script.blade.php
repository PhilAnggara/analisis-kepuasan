...
<script src="{{ url('frontend/vendors/simple-datatables/simple-datatables.js') }}"></script>
{{-- <script src="{{ url('src/assets/extensions/simple-datatables/umd/simple-datatables.js') }}"></script> --}}
...
<script src="{{ url('frontend/vendors/aos/aos.js') }}"></script>
